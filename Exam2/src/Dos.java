...
public class Dos {
	...
	public static int[] obtenerSol(int[] pesos, int[] capacidades) {
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(obtenerSol(pesos1, capacidades1)));
		System.out.println(Arrays.toString(obtenerSol(pesos2, capacidades2)));
		System.out.println(Arrays.toString(obtenerSol(pesos3, capacidades3)));
	}
}
